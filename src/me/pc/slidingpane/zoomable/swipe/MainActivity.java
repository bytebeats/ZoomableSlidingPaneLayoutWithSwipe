...
import me.pc.slidingpane.zoomable.swipe.MyListFragment.ListFragmentItemClickListener;
...
public class MainActivity extends Activity implements
	...
	private static final float SCALE_RATIO = 1.69f;
	...
	private class SliderListener extends
		...
		public void onPanelSlide(View view, float v) {
			Log.i("onPanelSlide", "offset---" + v);
			Fragment frag = getFragmentManager().findFragmentById(
					R.id.content_pane);
			View contentView = frag.getView();
			contentView.setScaleX(1 - v / SCALE_RATIO / SCALE_RATIO);
			contentView.setScaleY(1 - v / SCALE_RATIO / SCALE_RATIO);
			contentView.setAlpha(1 - v);
		}
	}
